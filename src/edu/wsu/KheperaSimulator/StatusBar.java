...
/**
 * Representation of a generic status bar for an application. This is a static class. In this case it provides the ability to call the methods from any where in
 * the application. For example, StatusBar.setCenterStatus(...);
 * 
...
public class StatusBar extends JPanel {
	 ...
	 * 
	 * @param s
	 *            a <tt>String</tt> representation of the status
	 */
