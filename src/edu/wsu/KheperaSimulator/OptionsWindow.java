...
/**
 * An <code>OptionsWindow</code> class represents the options window of the application. The options window contains interactive graphical components that allow
 * the user to setup or change the default settings of the application.
 */
public class OptionsWindow extends JDialog {
	...
	private void initComponents() {
		...
		distSliderPanel.add(new JLabel("Distance Sensor Sensitivity", SwingConstants.CENTER));
		...
		lightSliderPanel.add(new JLabel("Light Sensor Sensitivity", SwingConstants.CENTER));
		...
		speedSliderPanel.add(new JLabel("Robot Speed Sensitivity", SwingConstants.CENTER));
		...
		recordSpeedInterval.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage("images/record.gif")));
		...
		for (int i = 0; i < rInterval.length; ++i)
			// rInterval.length gives the array size
		...
		networkingSliderPanel.add(new JLabel("Server Transmition Rate:      ", SwingConstants.CENTER));
		...
		for (int i = 0; i < nInterval.length; ++i)
			// nInterval.length gives the array size
		...
		networkingSliderPanel.add(new JLabel("Server Port Number:      ", SwingConstants.CENTER));
		...
		for (int i = 0; i < pInterval.length; ++i)
			// nInterval.length gives the array size
