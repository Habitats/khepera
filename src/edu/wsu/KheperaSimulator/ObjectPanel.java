...
/**
 * The ObjectPanel defines a panel used to display the set of objects that can be added to the world. Like the original simulator, these objects (ie., ball,
 * cap, wall, light) can be rotated prior to placement.
 * 
...
public class ObjectPanel extends JPanel {
	...
	public void paint(Graphics g) {
		...
		case 3:
			...
			break;
		case 4:
			g2.setColor(new Color(42, 186, 52));
			g2.fillArc(22, 22, 16, 16, 0, 360);
	 ...
	 * 
	 * @param type
	 *            the current type of object selected.
	 */
	...
	/**
	 * Set the rotation direction. This value can be either 'CW' for clockwise or 'CCW' for counter-clockwise.
	 * 
	 * @param dir
	 *            the direction
	 */
