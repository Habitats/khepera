...
/**
 * An <code>ObjectDialog</code> class provides the GUI components and functionality to create maps with a variety of objects such as walls, balls, caps, and
 * lights.
 * 
...
public class ObjectDialog extends JPanel {
	...
	/**
	 * Allocate a new <code>ObjectDialog</code> object with access to the local simulator.
	 * 
	 * @param wPanel
	 *            the simulator <code>WorldPanel</code>
	 */
