...
/**
 * A <code>WorldDrawManager</code> class provides the main thread to run the simulator engine. This thread manages drawing routines, controller threads, various
 * book keeping and shared data.
 */
public class WorldDrawManager implements Runnable {
	...
	/**
	 * Access the value for the current sensor label display mode for GUI sensor value updates. Legal display modes are "distance", "light", and "disable".
	 * 
	...
	/**
	 * Change the value for the current sensor label display mode for GUI sensor value updates.
	 * 
	 * @param mode
	 *            display mode ("distance", "light", or "disable")
	 */
	...
	/**
	 * Sets values in the 500 x 500 world image matrix to appropriate values based on the presence and position of user placed objects (and the static outer
	 * walls). The matrix is simply another representation of the robot arena that uses object id numbers at pixel locations where objects are present.
	 */
	...
	/**
	 * Resets appropriate data before starting the <code>WorldDrawManager</code> thread.
	 */
	...
	/**
	 * Starts the main simulation thread, which runs the robot based on the currently loaded controller and generated sensor values.
	 */
	...
	/**
	 * Sets the varaiable parameter associated with distance sensor sensitivity to the value passed.
	 * 
	 * @param level
	 *            new distance sensor sensitivity level
	 */
	...
	/**
	 * Sets the varaiable parameter associated with light sensor sensitivity to the value passed.
	 * 
	 * @param level
	 *            new light sensor sensitivity level
	 */
	...
	/**
	 * Sets the varaiable parameter associated with calculating motor speeds to the value passed.
	 * 
	 * @param level
	 *            new speed adjustment level
	 */
