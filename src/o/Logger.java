...
public class Logger extends RobotController {
	 ...
	 * @param speed - the speed you want it to rotate at, [1, 5]. The bigger the speed, the lower the precision.
...
//				behaviors.add(new GoHome(10));
	...
	public class CollectBall extends Behavior {
		...
		public void run() {
			...
			case 1:
				...
				//				System.out.println((distanceSensors[SENSOR_FRONTL] + distanceSensors[SENSOR_FRONTR]) / 2);
	...
	private class GoHome extends Behavior{
		...
		@Override
		public boolean checkConditions() {
			if(state == 0 && getArmState() == KSGripperStates.ARM_UP && isObjectHeld()) return true;
