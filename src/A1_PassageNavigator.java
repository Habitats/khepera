...
public class A1_PassageNavigator extends AbstractController {
  ...
  protected void findBall() {
    ...
    if (System.currentTimeMillis() - startTime > 60000
        && Singleton.getInstance().getHistory().backWardSize() == 0)
  ...
  protected Turn evalCorner(Turn t) {
    // move a little forward in order to examine the corner and its surroundings, 410 is a little
    // more than one robot length, giving it some space
    forward(410);
