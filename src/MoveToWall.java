...
/**
 * Moves forward until it reaches a wall.
 * Turns to the left, and repeats.
 *
 * In an empty map, the robot will follow the wall, and never collide.
 *
 * There are some obvious problems with this, worth noticing.
 * - The robot only uses the two forward sensors, it may very well
 *   hit an edge just barely touching its course, as it never checks
 *   ANGLE-LEFT or ANGLE-RIGHT.
 * - This controller is really simple.
 *
 */

public class MoveToWall extends RobotController {
  public MoveToWall() {
  }
