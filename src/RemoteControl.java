 ...
 * 
 * Author: Duane Bolick Date: 13 JUN 2004 Version: 1.0
 * 
 */
public class RemoteControl extends AbstractController implements ActionListener {
	...
	public synchronized void doWork() throws Exception {
		if (hasUserInput) {
			...
			// If the user wants to quit, instruct them to click the 'halt'
			// button on
			// the main window. (There's no graceful way to end the thread via
			// this
			// controller)
			if (done)
				setFinished(true);
	...
	/**
	 * Accepts command input to the robot, parses the input, and calls the specified execution method.
	 * 
	 * <br>
	 * <br>
	 * Valid input strings are as follows. If a verbose command has a shortcut, it is listed in parentheses following the long command.
	 * 
	 * <ul>
	 ...
	 * 
	 * <ul>
	 * <b>Movement commands</b>. <br>
	 * May be followed by a flag (&lt;short&gt; <-s>, &lt;med&gt;, <-m>, &lt;long&gt;, <-l>).
	 ...
	 * 
	 * <ul>
	 * <b>Gripper actions</b>. <br>
	 * <i>Must</i> be followed by a flag (&lt;open&gt;, <-o>, &lt;close&gt;, <-c>).
	 * <li>grip (g)</li>
	 * </ul>
	 * 
	 * <ul>
	 * <b>Arm actions</b>. <br>
	 * <i>Must</i> be followed by a flag (&lt;up&gt;, <-u>, &lt;down&gt;, <-d>).
	 * <li>arm (a)</li>
	 * </ul>
	 * 
	 * @param input
	 *            The user's command line input.
	 * 
	...
	private synchronized boolean evalInput(String input) {
		...
		// help, added winter 2003 by Tom Mills, modified 12 JUN 2004 by Duane
		// Bolick
		...
		// System.out.println(alignedWithRightWall());
