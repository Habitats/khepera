...
/**
 * The <code>RobotCoordinates</code> class represents the current coordinates and direction of the robot. The information stored in this class is used for
 * drawing the robot and generating sensor data, and should not be used by the controller.
 * 
...
public class RobotCoordinates implements java.io.Serializable {
	...
	/**
	 * Allocate a new <code>RobotCoordinates</code> object and initialize it with default values.
	 */
	 ...
	 * @param dy
	 *            floating point representation of y
	 */
	 ...
	 *            floating point representation of y
	 */
	protected synchronized void setCoordinates(int x, int y, float a, float dx, float dy) {
		this.x = x;
		this.y = y;
		this.alpha = a;
		this.dx = dx;
