...
/**
 * The <code>CurrentRobotState</code> class represents the current state of the robot at any time. This class provides methods to set the current state of the
 * robot as well as to get the current state.
 * 
...
public class CurrentRobotState {
	...
	/**
	 * Allocates a new <code>CurrentRobotState</code> object. This object is initialized and set to a default state.
	 */
	...
	/**
	 * Reinitialize this <code>CurrentRobotState</code> object. This will reset the current state of the robot back to the default state.
	 */
	...
	/**
	 * Get the arm state of the robot. The state is either <tt>ARM_UP</tt> or <tt>ARM_DOWN</tt>.
	 * 
	 * @return the arm state.
	 */
	protected int getArmState() {
		return armState;
	}

	/**
	 * Set the arm state of the robot. The The state is either <tt>ARM_UP</tt> or <tt>ARM_DOWN</tt>.
	 * 
	 * @param arm
	 *            the arm state
	 */
	...
	/**
	 * Get the gripper state of the robot. The state is either <tt>GRIP_OPEN</tt> or <tt>GRIP_CLOSED</tt>.
	 * 
	 * @return the gripper state
	 */
	protected int getGripperState() {
		return gripperState;
	}

	/**
	 * Set the gripper state of the robot. The state is either <tt>GRIP_OPEN</tt> or <tt>GRIP_CLOSED</tt>.
	 * 
	 * @param grip
	 *            the gripper state
	 */
	 ...
	 */
	protected void postSensorValues(Sensor[] s) {
		sensors = s;
	}
	 ...
	 * 
	 * @return an array of <code>Sensor</code> objects where each contains the current sensor state.
	 */
	protected Sensor[] getSensorValues() {
		return sensors;
	}
	 ...
	 */
	protected void postResistivity(int rVal) {
		resistivity = rVal;
	}
	 ...
	 * Currently provides no valid state information.
	 */
	protected synchronized int getResistivity() {
		return resistivity;
	}

	/**
	 * Set the state about wheter an object exists between the gripper arms of the robot.
	 * 
	 * @param objPresent
	 *            a <code>boolean</code> value that represents the object present state
	 */
	...
	/**
	 * Provide state information about whether an object exists between the gripper arms of the robot.
	 * 
	 * @return <tt>true</tt> if an object is present, <tt>false</tt> otherwise
	 */
	protected synchronized boolean isObjectPresent() {
		return objPresent;
	}
	 ...
	 */
	protected boolean isObjectHeld() {
		return objHeld;
	}
	 ...
	 * 
	 * @param oHeld
	 *            a value that is <tt>true</tt> if an object is held, <tt>false</tt> otherwise
	 */
	protected void setObjectHeld(boolean oHeld) {
		objHeld = oHeld;
	}
	 ...
	 * 
	 * @return a <code>RobotCoordinates</code> object with coordinate state information
	 */
	protected RobotCoordinates getRobotCoordinates() {
		return currentPos;
	}
	 ...
	 * 
	 * @param x
	 *            the x-coordinate position of the robot
	 * @param y
	 *            the y-coordinate position of the robot
	 * @param a
	 *            the angle theta of directional orientation of the robot
	 */
